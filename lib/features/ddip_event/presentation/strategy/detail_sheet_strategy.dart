...
const double detailPeekFraction = 0.20; // 초기 높이
const double detailMidFraction = 0.40; // 중간 높이
...
class DetailSheetStrategy extends BaseBottomSheetStrategy {
  ...
  DetailSheetStrategy() : super(detailPeekFraction);
  ...
  void showMid() {
    state = detailMidFraction;
  }

  void minimize() {
    state = detailPeekFraction;
  }
}
